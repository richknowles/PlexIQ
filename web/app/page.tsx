...
const CSS = `
  ...
  .hit-target td {
    animation:chicagoExecution 3s ease-out forwards;
    overflow:hidden;
  }
  ...
  .hit-target td:first-child::before {
    bottom:8px;
    left:3px;
    animation:smokeLeft1 2.25s ease-out 0.3s forwards;
  }
  ...
  .hit-target td:first-child::after {
    ...
    width:35px;
    height:35px;
    animation:smokeLeft2 2.4s ease-out 0.55s forwards;
  }
  ...
  .hit-target td:nth-child(2)::before {
    bottom:12px;
    left:15px;
    animation:smokeLeft3 2.3s ease-out 0.4s forwards;
  }

  .hit-target td:nth-child(2)::after {
    bottom:5px;
    left:25px;
    animation:smokeCenter 2.5s ease-out 0.7s forwards;
  }
  ...
  .hit-target td:last-child::before {
    bottom:8px;
    right:3px;
    animation:smokeRight1 2.25s ease-out 0.35s forwards;
  }
  ...
  .hit-target td:last-child::after {
    ...
    width:35px;
    height:35px;
    animation:smokeRight2 2.4s ease-out 0.6s forwards;
  }
  ...
  .hit-target td:nth-last-child(2)::before {
    bottom:12px;
    right:15px;
    animation:smokeRight3 2.3s ease-out 0.45s forwards;
  }

  .hit-target td:nth-last-child(2)::after {
    bottom:5px;
    right:25px;
    animation:smokeCenter 2.5s ease-out 0.75s forwards;
  }

  /* Kill shot lands slightly later on the title column for stagger feel */
  .hit-target td:nth-child(3) {
    animation:chicagoExecution 3s ease-out 0.03s forwards;
    overflow:hidden;
  }
